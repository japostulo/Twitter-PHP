...
<div class="w-1/6">
    <nav>
        <a href="{path: '/'}" class="block cursor-pointer text-center fa fa-twitter fa-2x w-16 mb-8"></a>


        <a href='{{route('home')}}' class="cursor-pointer m-10">
        ...
        <a href='{{route("explore")}}' exact class="cursor-pointer m-10">
            <div class="hover:text-blue-500">
        ...
        <a href='{{route("notifications")}}' exact class="cursor-pointer m-10">
            <div class="hover:text-blue-500">
        ...
        <a href='{{route("messages")}}' exact class="cursor-pointer m-10">
            <div class="hover:text-blue-500">
        ...
        <a href='{{route("bookmarks")}}' exact class="cursor-pointer m-10">
            <div class="hover:text-blue-500">
        ...
        <a href='{{route("lists")}}' exact class="cursor-pointer m-10">
            <div class="hover:text-blue-500">
        ...
        <a href='{{route("profile")}}' exact class="cursor-pointer m-10">
            <div class="hover:text-blue-500">
